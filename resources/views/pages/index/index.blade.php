            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Email: <a href="mailto:igor.peshkov@gmail.com">igor.peshkov@gmail.com</a>
                        </p>
                        <p class="card-text">
                            Skype: <a href="skype:igor.peshkov.1988?chat">igor.peshkov.1988</a>
                        </p>
                        <p class="card-text">
                            Facebook: <a href="https://www.facebook.com/igor.peshkov.27.07.1988/" target="_blank" >igor.peshkov.27.07.1988</a>
                        </p>
                    </div>
                </div>
            </div>
